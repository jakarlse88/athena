...
{
    public class TechniqueCategoryValidatorTests
    {
        private readonly TechniqueCategoryValidator _validator;

        public TechniqueCategoryValidatorTests()
        {
            _validator = new TechniqueCategoryValidator();
        }
